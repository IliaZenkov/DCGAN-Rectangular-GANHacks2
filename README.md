...
Gradients are of good magnitude throughout the discriminator's layers:
...
The Discriminator's gradients are too low for any information gain to pass to the Generator:
